...
if(e23.isTouching(dream)&&keyDown("space")&&score<5&&score>3){
  dream.x=2700;
  dream.y=2205;
}
if(note1.isTouching(dream)&&keyDown("space")&&help>-1&&help<1){
  help=1;
}
if(note2.isTouching(dream)&&keyDown("space")&&help>0&&help<2){
  help=2;
}
if(note3.isTouching(dream)&&keyDown("space")&&help>1&&help<3){
  help=3;
}
if(note4.isTouching(dream)&&keyDown("space")&&help>2&&help<4){
  help=4;
}
if(object1.isTouching(dream)&&keyDown("space")&&help<5&&help<3){
  dream.x=2300;
  dream.y=2145;
}
if(lever4.isTouching(dream)&&keyDown("space")&&score<5&&score>3){
  hall22.x=100000;
  lever4.changeImage("on",onImage);
  fault=1;
}
if(note5.isTouching(dream)&&keyDown("space")&&score>-1&&score<1){
  score=1;
}
if(note6.isTouching(dream)&&keyDown("space")&&score<2&&score>0){
  score=2;
}
if(note7.isTouching(dream)&&keyDown("space")&&score<3&&score>1){
  score=3;
}
if(note8.isTouching(dream)&&keyDown("space")&&score<4&&score>2){
  score=4;
}
if(note1.isTouching(dream)&&keyDown("space")&&help>5&&help<3){
  dream.x=2300;
  dream.y=2150;
}
console.log(score);
